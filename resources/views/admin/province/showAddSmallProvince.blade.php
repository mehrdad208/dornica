    ...
    <section class="col-12">
        <section class="main-body-container">
            <section class="main-body-container-header">
                <h5>
                 اضافه کردن شهرستان جدید برای  {{$province->title }}
                </h5>
            </section>
            @if(session('success'))
            ...
            <section>
                <form action="{{route('admin.smallProvince.store',$province->id)}}" method="post" >
                    @csrf
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="small_province" class="form-control form-control-sm" value="">
                            </div>
                            @error('first_name')
