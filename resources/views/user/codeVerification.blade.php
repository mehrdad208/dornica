    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{route('user.verification.store',$user->id)}}" method="POST"  id="form">
                        @csrf
                        <section class="row">
                            ...
                            <section class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="verification_code" value="{{old('email')}}">
                                </div>
                                @error('email')
